  ...
  <div class="content flex-grow-1">
    <nav class="navbar navbar-expand-lg px-3 mb-4">
      <div class="container-fluid">
        <span class="navbar-brand text-light fw-semibold"><i class="bi bi-door-open"></i> DAFTAR HADIR</span>
    ...
    <div class="mb-4" >
      <form method="GET" class="row g-3 align-items-end">
        <div class="col-md-4">
          ...
          <select name="jurusan" id="jurusan" class="form-select text-center">
        ...
        <div class="col-md-4">
          ...
          <select name="tingkat" id="tingkat" class="form-select text-center">
              ...
              <tbody>
                <?php $no=1; foreach($siswa_list as $s): ?>
                  <tr>
                    ...
                    <td>
                      <a href="edit_absen.php?siswa_id=<?= $s['siswa_id'] ?>&tanggal=<?= $s['tanggal'] ?>" 
