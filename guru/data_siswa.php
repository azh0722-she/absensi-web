...
// Ambil data guru sesuai user_id
...
// Jika guru tidak ditemukan, gunakan default
if (!$guru) {
    $guru = [
...
if (!empty($keyword)) {
    ...
    // Validasi agar NIS hanya angka, tapi tetap bisa mencari nama/jurusan
        ...
        <nav class="navbar navbar-expand-lg px-3 mb-4">
            <div class="container-fluid">
                ...
                <div class="d-flex align-items-center">
                    <img src="<?= htmlspecialchars($guru['foto']) ?>" alt="Foto Profil">
