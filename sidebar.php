...
<body>
  <div class="sidebar p-3">
    ...
    <a href="data_guru.php"><i class="bi bi-person-lines-fill"></i> Data Guru</a>
    <a href="laporan.php"><i class="bi bi-graph-up"></i> Laporan</a>
    <a href="user.php"><i class="bi bi-person-lines-fill"></i> Pengguna</a>
    <a href="profil_admin.php"><i class="bi bi-gear"></i> Profil</a>
    <hr style="border-color: rgba(255, 255, 255, 0.1)" />
    <a href="#" class="text-danger" id="logoutBtn"><i class="bi bi-box-arrow-left"></i> Logout</a>
  </div>
